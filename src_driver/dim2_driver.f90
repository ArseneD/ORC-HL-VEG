PROGRAM driver
!< $HeadURL: svn://forge.ipsl.jussieu.fr/orchidee/trunk/ORCHIDEE/src_driver/dim2_driver.f90 $ 
...
!-
  ...
  if (debug) WRITE(numout,*) 'INPUT RESTART_FILE : ',TRIM(driv_restname_in)
!-
...
!-
  ...
  if (debug) WRITE(numout,*) 'OUTPUT RESTART_FILE : ',TRIM(driv_restname_out)
!-
...
! in the forcing chronology.
  ...
  IF (debug) WRITE(numout,*) 'driver_reset_time=',driver_reset_time
