...
PROGRAM forcesoil
  ...
  CHARACTER(LEN=2000)                        :: taboo_vars             !! string used for storing the name of the variables 
  ...
  INTEGER(i_std),PARAMETER                   :: nbvarmax=500           !! maximum # of variables assumed in the stomate restart file 
                                                                       !! (unitless)
  INTEGER(i_std)                             :: nbvar                  !! # of variables effectively present 
                                                                       !! in the stomate restart file (unitless)
  CHARACTER(LEN=200),DIMENSION(nbvarmax)      :: varnames              !! list of the names of the variables stored 
                                                                       !! in the stomate restart file (unitless)
...
!         ALLOCATE (zz_coef_deep(ndeep))
     ...
     ELSE
         ...
         &            '$day_counter$ $dt_days$ $date$ '// &
         &            '$deepC_a_01$ $deepC_a_02$ $deepC_a_03$ $deepC_a_04$ $deepC_a_05$ $deepC_a_06$ '// &
         &            '$deepC_a_07$ $deepC_a_08$ $deepC_a_09$ $deepC_a_10$ $deepC_a_11$ $deepC_a_12$ $deepC_a_13$ '// &
         &            '$deepC_s_01$ $deepC_s_02$ $deepC_s_03$ $deepC_s_04$ $deepC_s_05$ $deepC_s_06$ '// &
         &            '$deepC_s_07$ $deepC_s_08$ $deepC_s_09$ $deepC_s_10$ $deepC_s_11$ $deepC_s_12$ $deepC_s_13$ '// &
         &            '$deepC_p_01$ $deepC_p_02$ $deepC_p_03$ $deepC_p_04$ $deepC_p_05$ $deepC_p_06$ '// &
         &            '$deepC_p_07$ $deepC_p_08$ $deepC_p_09$ $deepC_p_10$ $deepC_p_11$ $deepC_p_12$ $deepC_p_13$ '// &
         &            '$O2_soil_01$ $O2_soil_02$ $O2_soil_03$ $O2_soil_04$ $O2_soil_05$ $O2_soil_06$ '// &
         &            '$O2_soil_07$ $O2_soil_08$ $O2_soil_09$ $O2_soil_10$ $O2_soil_11$ $O2_soil_12$ $O2_soil_13$ '// &
         &            '$CH4_soil_01$ $CH4_soil_02$ $CH4_soil_03$ $CH4_soil_04$ $CH4_soil_05$ $CH4_soil_06$ '// &
         &            '$CH4_soil_07$ $CH4_soil_08$ $CH4_soil_09$ $CH4_soil_10$ $CH4_soil_11$ $CH4_soil_12$ $CH4_soil_13$ '// &
         &            '$O2_snow_01$ $O2_snow_02$ $O2_snow_03$ $O2_snow_04$ $O2_snow_05$ $O2_snow_06$ '// &
         &            '$O2_snow_07$ $O2_snow_08$ $O2_snow_09$ $O2_snow_10$ $O2_snow_11$ $O2_snow_12$ $O2_snow_13$ '// &
         &            '$CH4_snow_01$ $CH4_snow_02$ $CH4_snow_03$ $CH4_snow_04$ $CH4_snow_05$ $CH4_snow_06$ '// &
         &            '$CH4_snow_07$ $CH4_snow_08$ $CH4_snow_09$ $CH4_snow_10$ $CH4_snow_11$ $CH4_snow_12$ $CH4_snow_13$ '
     ENDIF
     !-
  ...
  ELSE
      ...
      DO i=1,itau_len
        ...
        CALL deep_carbcycle(kjpindex, indices, iatt, dt_forcesoil*one_day, lalo, clay, &
             ...
             veget_max(:,:,iatt), rprof(:,:,iatt), altmax,  carbon, carbon_surf, resp_hetero_soil, dt_forcesoil*one_day, &
