...
!
!
!< $HeadURL: svn://forge.ipsl.jussieu.fr/orchidee/trunk/ORCHIDEE/src_global/interpol_help.f90 $
...
CONTAINS
  ...
  SUBROUTINE aggregate_vec (nbpt, lalo, neighbours, resolution, contfrac, &
    ...
    IF (ALLOC_ERR/=0) THEN
      WRITE(numout,*) "aggregate_vec : ERROR IN ALLOCATION of fine_ind : ",ALLOC_ERR
      STOP 
    ENDIF
    !
