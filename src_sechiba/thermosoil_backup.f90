...
!Isa
        & profil_froz,pb,snowtemp,snowrho,&
...
!_ ================================================================================================================================
 ...
 !Isa
  & snow, profil_froz,pb,snowtemp,snowrho, &
...
!Isa --
    REAL(r_std), DIMENSION (kjpindex), INTENT (in)           :: pb                !! surface pressure
    REAL(r_std), DIMENSION (kjpindex,nsnow),INTENT(in)       :: snowtemp,snowrho
...
!Isa
	& profil_froz, pcappa_supp, stempdiag, &
        & organic_layer_thick, soilc_total,veget_max)
