...
!!
!! SVN          :
!! $HeadURL: svn://forge.ipsl.jussieu.fr/orchidee/trunk/ORCHIDEE/src_stomate/lpj_constraints.f90 $
  ...
  !! 2. Calculate ::adapted and ::regenerate
    ...
    DO j = 2,nvm ! Loop over # PFTs
       ...
       IF ( natural(j) .OR. agriculture ) THEN
          ...
          !! 2.1.1.1 There is no critical temperature for the PFT 
...
!             ENDWHERE
!
!             ! The PFT does not disappear after a single cold shock. The PFT has a memory
...
!!! Arsene 19-08-2014 END if shrub
          ...
          !DZ modified: "seasonal" temperature Tseason must exceed 7 degree for trees to be declared adapted.
          !
