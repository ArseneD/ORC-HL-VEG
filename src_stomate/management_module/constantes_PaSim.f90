...
MODULE constantes_PaSim
  ...
  REAL(r_std), PARAMETER :: CH4toC                    = 0.75        @equation constantes::CH4toC
  ...
  !20/03/2009 AIG & MG
  INTEGER, SAVE :: n_out          = 3      !Is the number of output for autogestion mangement run in import Yield file. 
