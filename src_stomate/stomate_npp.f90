...
!!
!! SVN          :
!! $HeadURL: svn://forge.ipsl.jussieu.fr/orchidee/trunk/ORCHIDEE/src_stomate/stomate_npp.f90 $
...
!JCADD
    CALL histwrite (hist_id_stomate, 'SLA_CALC', itime, &
...
!BEGINNVADD
    ...
    CALL histwrite (hist_id_stomate, 'NPP_ABOVE', itime, &
                    npp_above, npts*nvm, horipft_index)
    CALL histwrite (hist_id_stomate, 'NPP_BELOW', itime, &
