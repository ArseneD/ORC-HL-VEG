...
!!
!! SVN          :
!! $HeadURL: svn://forge.ipsl.jussieu.fr/orchidee/trunk/ORCHIDEE/src_stomate/stomate_phenology.f90 $ 
...
!!                ::firstcall, ::firstcall_hum, ::firstcall_moi, ::firstcall_humgdd, 
...
!! RECENT CHANGE(S): None
!!
!! MAIN OUTPUT VARIABLE(S): ::firstcall, ::firstcall_hum, ::firstcall_moi, ::firstcall_humgdd, 
!!                ::firstcall_moigdd
!!
!! REFERENCE(S)  : None
!!
...
!ENDJCADD                                                                                                !! on (true/false) 
   ...
   ! LOGICAL, DIMENSION(npts,nvm)                                        :: begin_leaves         !! signal to start putting leaves 
                                                                                                !! on (true/false) 
...
!_ ================================================================================================================================
  ...
  SUBROUTINE pheno_humgdd (npts, j, PFTpresent, allow_initpheno, gdd, &
    ...
    REAL(r_std), DIMENSION(npts,nvm), INTENT(in)             :: minmoiavail_lastyear    !! last year's minimum moisture 
                                                                                        !! availability (0-1, unitless)
    REAL(r_std), DIMENSION(npts), INTENT(in)                 :: tlong_ref               !! "long term" 2 meter temperatures (K)
...
!_ ================================================================================================================================
  ...
  SUBROUTINE pheno_moi_C4 (npts, j, PFTpresent, allow_initpheno, gdd, &
    ...
    IF (bavard.GE.3) WRITE(numout,*) 'Entering moi_C4'
    ...
    IF (bavard.GE.4) WRITE(numout,*) 'Leaving moi_C4'
